...
//             <Image className=" mx-[300px]" alt="login image" src={img} width={800} height={900}></Image>
//           </div>
...
//           </Link>
//           <div className="mt-2">
//             <button type="submit" className="w-full px-4 py-2 tracking-wide text-gray-300 transition-colors duration-200 transform bg-[#ea4c89] rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600">
//               Sign In
//             </button>
//           </div>
//         </form>

//         <div className="relative bg-gray-800  flex items-center  justify-center w-full  mt-6 border border-t">
//         </div>
