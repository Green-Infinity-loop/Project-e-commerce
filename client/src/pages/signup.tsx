...
import img from '../image/signup/Medicine-rafiki.png'
        ...
        >
          <div className="mb-4">
            ...
            <input
              ...
              className="block w-full px-4 py-2 mt-2 text-gray-700 bg-gray-700 border rounded-md focus:border-gray-400 focus:ring-gray-300 focus:outline-none focus:ring focus:ring-opacity-40"
            />
          </div>
          <div className="mb-2">
            <label
          ...
          <div className="mb-2">
            ...
            <input
              ...
              className="block mb-5 w-full px-4 py-2 mt-2 text-gray-400 bg-gray-700 border rounded-md focus:border-gray-400 focus:ring-gray-300 focus:outline-none focus:ring focus:ring-opacity-40"
            />
          </div>
          <div className="mt-2">
            <button className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-[#ea4c89] rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600">
              CREATE ACCOUNT
            </button>
          </div>
        </form>
...
<path fill="#039be5" d="M24 5A19 19 0 1 0 24 43A19 19 0 1 0 24 5Z"></path><path fill="#fff" d="M26.572,29.036h4.917l0.772-4.995h-5.69v-2.73c0-2.075,0.678-3.915,2.619-3.915h3.119v-4.359c-0.548-0.074-1.707-0.236-3.897-0.236c-4.573,0-7.254,2.415-7.254,7.917v3.323h-4.701v4.995h4.701v13.729C22.089,42.905,23.032,43,24,43c0.875,0,1.729-0.08,2.572-0.194V29.036z"></path>
    ...
    <div className="col-span-3  flex h-screen w-full justify-center items-center">
          ...
          <div className="bg-gray-800 rounded-2xl ">
            <Image className=" mx-[300px] p-[100px] "  alt="login image" src={img} width={800} height={900}></Image>
          </div>
