    ...
    <div className="-mx-4 flex flex-wrap">
      <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
        <div className="mb-10 w-full">
          <Link href="javascript:void(0)" className="mb-6 bg-white rounded-[35px] inline-block max-w-[160px]">
            <Image
            src={logo}
          ...
          <div className="text-body-color mb-7 text-base">"Би салхины чиглэлийг өөрчилж чадахгүй ч завийн далбааг хүрэх цэгт очиход залуурдаж чадна"</div>
        
        </div>
      </div>
      <div className="w-full mt-5 px-4 sm:w-1/2 lg:w-2/12">
        <div className="mb-10 w-full">
          <h4 className="text-dark mb-9 text-lg font-semibold">Resources</h4>
          
            
            {resources.map(function(d){
         return (<Link className="text-body-color hover:text-primary mb-2 inline-block text-base leading-loose" href="/" key={d}>{d}</Link>)
       })}
      ...
      <div className="w-full mt-4 px-4 sm:w-1/2 lg:w-3/12">
        <div className="mb-10 w-full">
