...
const links = ["Premium Support", "Our Services", "Know Our Team"];

export default function Footer(): any {
  return (
    <>
      <footer className="relative z-10 bg-[#115061] text-white pt-20 pb-10 lg:pt-[120px] lg:pb-20">
            ...
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <div className="text-body-color mb-7 text-base">
                  Би салхины чиглэлийг өөрчилж чадахгүй ч завийн далбааг хүрэх
                  цэгт очиход залуурдаж чадна
                </div>
              </div>
            </div>
