          ...
          <ul className="space-y-2 font-medium">
            ...
            <li className="">
              <Grid container spacing={2} className="flex justify-center gap-4">
                <Grid xs={5}>
                  <div className="text-white border rounded-xl text-center p-3 bg-[#615cbe]">
                    id dar
                  </div>
                </Grid>
                <Grid xs={5}>
                  <div className="text-white border rounded-xl text-center p-3 bg-[#615cbe] w-full">
                    Nmaig dar
                  </div>
                </Grid>
              </Grid>
            ...
            <li>
              <button className="border bg-[#615cbe] w-full rounded-xl">
                <a
                  href="#"
