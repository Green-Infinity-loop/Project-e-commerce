...
export default function Sidebar() {
  ...
  function Sidebar() {
    return (
      <>
        ...
        <aside
          id="default-sidebar"
          className="fixed top-0 right-0 z-40 w-82 h-screen transition-transform -translate-x-full sm:translate-x-0"
          aria-label="Sidebar">
            ...
            <ul className="space-y-2 font-medium">
              ...
              <li className="">
                <Grid
                  ...
                  <Grid xs={5}>
                    <div className="text-white border rounded-xl text-center p-3 bg-[#115061]">
                      id dar
                    </div>
                  </Grid>
                  <Grid xs={5}>
                    <div className="text-white border rounded-xl text-center p-3 bg-[#115061] w-full">
                      Nmaig dar
                    </div>
                  </Grid>
                </Grid>
              ...
              <li>
                <button className="border bg-[#115061] w-full rounded-xl">
                  <a
                    href="#"
  ...
  return (
    <button
      type="button"
      className=" p-1 text-[#181D31]   absolute z-50 right-100">
